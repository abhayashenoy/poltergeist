...
Poltergeist.Browser = (function() {
  ...
  Browser.prototype.inner_html = function(page_id, id) {
    return this.sendResponse(this.node(page_id, id).innerHTML());
  };

  Browser.prototype.outer_html = function(page_id, id) {
    return this.sendResponse(this.node(page_id, id).outerHTML());
  };
